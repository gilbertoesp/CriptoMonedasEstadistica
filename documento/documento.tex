...
\section{An\'alisis BTC vs ETH vs BCH}
    ...
    \rowcolor[HTML]{9B9B9B} 
    Max                                                                                 & 7405                               & 7617                                & 7617                                & 7407          \\ \hline
    \end{tabular}
    \end{table}

    COMENTARIO SOBRE LO QUE SE VE EN LA TABLA Y PREELIMINAR 
    ...
    \hline
    \rowcolor[HTML]{9B9B9B} 
    {\color[HTML]{333333} \begin{tabular}[c]{@{}l@{}}Ethereum\\ 2015-04-28\end{tabular}} & {\color[HTML]{333333} Precio abre} & {\color[HTML]{333333} Precio mayor} & {\color[HTML]{333333} Precio menor} & Precio cierra \\ \hline
