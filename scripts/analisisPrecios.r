...
BTC = read.csv("csv/btc/bitcoin_price.csv", header = TRUE)
ETH = read.csv("csv/eth/ethereum_price.csv", header = TRUE)
...
#	Summary
	...
	sink("results/BitcoinSummary.txt")
	the_summarys(BTC)
	sink("results/EthereumSummary.txt")
	the_summarys(ETH)
...
# Boxplot
	...
	plot(BTC[["Low"]], col="RED", main="Bitcoin", type="l", ylab="Price", xlab="Date")
	lines(BTC[["High"]], col="GREEN")
	lines(BTC[["Open"]], col="BLUE")
	lines(BTC[["Close"]], col="YELLOW")
	

	plot(ETH[["Low"]], col="RED", main="Ethereum", type="l", ylab="Price", xlab="Date")
	lines(ETH[["High"]], col="GREEN")
	lines(ETH[["Open"]], col="BLUE")
	lines(ETH[["Close"]], col="YELLOW")
