...
ggplot(set, aes(set$Date, set$btc_total_bitcoin)) + geom_line() + 
	...
	theme(axis.text=element_text(size=12), axis.title=element_text(size=14,face="bold"), title=element_text(size=20), legend.text=element_text(size=20))
...
ggplot(set, aes(set$Date)) + 
	...
	labs(x="Date", y="Precio USD", title="Cantidad de monedas y total de Recompensas otorgadas", size=20) +
	theme(axis.text=element_text(size=12), axis.title=element_text(size=14,face="bold"), title=element_text(size=20), legend.text=element_text(size=20))